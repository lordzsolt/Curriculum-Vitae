...
\begin{itemize}%
	\item Implementing video and audio streaming, decoding and support for seeking functionality
	\item Maintaining and improving existing \textbf{iOS} applications
	\item Create an interface for communication between native Objective-C and JavaScript with \textbf{Cordova}
	\item Implement XMPP server communication with XML formatted messages
	\item Managing source code through \textbf{Version Control} (SVN)
\end{itemize}
}
