...
\cventry[10pt]{November 2015--Present}{iOS Developer}{Halcyon Mobile}{Cluj-Napoca}{}{
	\begin{itemize}%
		\item Developed \href{https://itunes.apple.com/us/app/smartup-the-startup-app/id938860815?mt=8}{\textbf{SmartUp}} and \href{https://itunes.apple.com/us/app/dbs-learn/id1123916060?mt=8}{\textbf{DBS Learn}}
		\item Worked with multiple architectures, such as \textbf{MVVM}, \textbf{MVC}, \textbf{FLUX}
		\item Implemented applications using \textbf{Functional reactive programming} paradigm through \textbf{Reactive Cocoa}
		\item Worked on multiple research projects with \textbf{Swift}
		\item Contribute to multiple Open-Source libraries
		\item Worked closely with UI/UX team to provide beautiful, user centered interfaces
	\end{itemize}
}
...
\begin{itemize}%
	...
	\item Implement functional and beautiful interfaces for all iOS devices through the extensive use of \textbf{Autolayout}
	\item Maintain and improve existing code
	\item Regular interaction with clients to deliver accurate results within schedule
	\item Managed source code through \textbf{Version Control} (Git)
\end{itemize}
}

\section{Education}
\cventry{September 2012–--July 2016}{B.Sc. (Hons.) Computer Engineering}{Sapientia Hungarian University of Transylvania}{Târgu-Mureș}{}{
\begin{itemize}%
...
\cventry{April 2016}{Automated supervision of vulnerable people's health}{XV. Scientific Students’ Associations Conference}{}{}{
	\begin{itemize}%
		\item Won special prize for most innovative thesis
	\end{itemize}
}
